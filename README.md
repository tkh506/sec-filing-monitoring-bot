...
- Bonus: optional alerts for changes to a public fund's portfolio page (holdings added/removed,
  portfolio weighting, NAV per share) — toggle on/off with one button.
